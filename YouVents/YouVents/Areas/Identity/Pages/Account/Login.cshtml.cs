...
namespace YouVents.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            else // No @ in the input, likely a username then
            {
            ...
            {
                // Get the user's input for the username/email field
                var userName = Input.Email;
                if (userName.IndexOf('@') > -1)
                {
                    // Get the user by their email (if email was input) and get their UserName so they can be logged in
                ...
                // Login the user with their username
